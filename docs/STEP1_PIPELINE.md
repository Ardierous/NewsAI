...
Фильтр **`recent_top5_repeat`** (по умолчанию вкл.): та же страница статьи (отпечаток host+path), что уже была в топ-5 одного из **7 предыдущих зафиксированных** выпусков (кнопка «Зафиксировать» на шаге 4), не попадает в пул. Другой URL — другая публикация, даже при похожем сюжете. При **пересборке пула** URL из текущего пула, не отмеченные галочкой, исключаются из нового сбора (в том числе при полной пересборке без сохранённых строк).
