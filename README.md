...
- Текущее состояние проекта зафиксировано как **«точка А»** (19.08.2026).
- В рабочих обсуждениях фраза «до точки А» означает состояние проекта до этого набора изменений.
