    ...
    return CrewAgents(
        ...
        analytics=Agent(
            ...
            backstory=(
                ...
                "суть в одну строку, развёрнутый analysis с шестью углами (важность, аудитория, польза/вред, "
                "последствия, что делать), без служебных меток и без готового текста для читателей."
            ),
