...
STEP1_FILTER_CATALOG: tuple[Step1FilterDef, ...] = (
    ...
    Step1FilterDef(
        "recent_top5_repeat",
        "Повтор из топ-5",
        "Та же страница статьи (URL), что уже была в топ-5 одного из 7 предыдущих зафиксированных выпусков "
        "(после «Зафиксировать»). При включении отсекается уже на шаге 1; на шаге 2 выбор такой новости "
        "в пятёрку всё равно запрещён.",
        "pre_http",
    ...
    Step1FilterDef(
        ...
        "нейтральных AI-материалов без развлекательного угла.",
        "verify",
        default_enabled=True,
