...
_SETTING_ENV: dict[str, str] = {
    ...
    "step1_telegram_max_digest_posts": "STEP1_TELEGRAM_MAX_DIGEST_POSTS",
    "step1_telegram_post_text_filter": "STEP1_TELEGRAM_POST_TEXT_FILTER",
    "step1_telegram_timeout_sec": "STEP1_TELEGRAM_TIMEOUT_SEC",
    "step1_telegram_via_proxyapi": "STEP1_TELEGRAM_VIA_PROXYAPI",
    "step1_telegram_direct_fallback": "STEP1_TELEGRAM_DIRECT_FALLBACK",
    "step1_telegram_proxyapi_context_size": "STEP1_TELEGRAM_PROXYAPI_CONTEXT_SIZE",
...
_PIPELINE_FIELDS = frozenset(
    {
        ...
        "step1_telegram_max_digest_posts",
        "step1_telegram_post_text_filter",
        "step1_telegram_timeout_sec",
        "step1_telegram_via_proxyapi",
        "step1_telegram_direct_fallback",
        "step1_telegram_proxyapi_context_size",
        "step1_seed_urls_max",
        "step2_max_cost_rub",
    ...
    sections: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "items": [
                ...
                _item(
                    "Telegram max digest posts",
                    settings.step1_telegram_max_digest_posts,
                    "step1_telegram_max_digest_posts",
                ),
                _item(
                    "Telegram post filter",
                    settings.step1_telegram_post_text_filter,
                    "step1_telegram_post_text_filter",
                ),
                _item("Telegram timeout (с)", settings.step1_telegram_timeout_sec, "step1_telegram_timeout_sec"),
                _item(
                    "Telegram через ProxyAPI",
                    settings.step1_telegram_via_proxyapi,
                    "step1_telegram_via_proxyapi",
                ),
                _item(
                    "Telegram fallback t.me",
                    settings.step1_telegram_direct_fallback,
                    "step1_telegram_direct_fallback",
                ),
                _item(
                    "Telegram ProxyAPI context",
                    settings.step1_telegram_proxyapi_context_size,
                    "step1_telegram_proxyapi_context_size",
                ),
