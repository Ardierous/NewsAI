      ...
      <details className="digest-step-details">
        ...
        <div className="digest-step-details-body">
          ...
          <div className="digest-hints-stack">
            ...
            <Acc title="Шаг 0 — режим «Дайджест ИИ» и окно новостей">
              <p style={{ ...li, marginTop: 0 }}>
                Задаётся единый режим «Дайджест ИИ» (деловые + практичные + умеренно развлекательные материалы) и окно по
                дате публикации (календарные или рабочие дни). Без сохранения шага 0 сервер не переведёт выпуск в{" "}
                <code style={c}>step_0</code>, шаг 1 вернёт 400.
              </p>
              <ul style={{ margin: "0 0 0 1.1rem", padding: 0 }}>
                <li style={li}>
            ...
            <Acc title="Шаг 2 — выбор пяти и порядок">
              <p style={{ ...li, marginTop: 0 }}>
                ...
                запускается после «Применить порядок» (если на сервере включён автозапуск шага 3). «Оптимально по мнению ИИ»
                переставляет карточки и показывает аргументацию, но шаг 3 не стартует — остаётесь на шаге 2.
              </p>
              <ul style={{ margin: "0 0 0 1.1rem", padding: 0 }}>
                <li style={li}>
            ...
            <Acc title="Шаги 3–4 — аналитика и финал">
              <p style={{ ...li, marginTop: 0 }}>
                ...
                анализ) и хэштеги; материал для редактора, не для публикации читателям. <strong>Шаг 4</strong> — при
                необходимости AI-обложки (если включены на сервере), тексты площадок и QC. Под каждым заголовком в постах —
