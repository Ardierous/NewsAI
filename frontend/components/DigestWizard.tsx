  ...
  const renderStep2ManualUrlBlock = (opts?: { marginTop?: number; marginBottom?: number }) =>
    canAddStep2ManualUrl ? (
      <div style={{ marginBottom: opts?.marginBottom ?? 14, marginTop: opts?.marginTop ?? 0 }}>
        ...
        <p className="wizard-hint-do" style={{ fontSize: "0.9rem", margin: "0 0 8px", color: "#cbd5e1" }}>
          Лучше всего подходят прикладные материалы: «как использовать», «сравнение сервисов», «кейсы внедрения» для
          обычной работы и жизни.
        </p>
        <textarea
          rows={2}
    ...
    <div className="grid">
      ...
      <div className="card" ref={step1CardRef}>
        ...
        <ul className="wizard-hint-do-list">
          ...
          <li>
            Для практичного выпуска добавляйте ссылки на разборы и сравнения ИИ‑инструментов «для работы/учёбы/быта», а не
            только новости о релизах моделей.
          </li>
          <li>
        ...
        {digest?.analytics?.length > 0 && (
          <div style={{ marginTop: 12 }}>
            <WizardWhy summary="Как читать блоки по новостям и хэштеги">
              ...
              <p>
                Для практического фокуса особенно полезны новости, где в блоках «Польза» и «Аудитория» видно конкретный
                сценарий: что именно человек или команда смогут делать быстрее/проще с помощью ИИ.
              </p>
            </WizardWhy>
